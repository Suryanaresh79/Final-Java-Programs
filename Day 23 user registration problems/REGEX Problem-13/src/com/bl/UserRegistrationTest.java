...
public class UserRegistrationTest {
	...
	public void test_lastName_Cases() {
		List<Boolean> result = lastNameTestCases
				.apply(Arrays.asList("Dahiwale", "Phalake", "Chougule", "Chougule", "dvsd"));
		List<Boolean> expected = Arrays.asList(true, true, true, true, false);
		assertEquals(expected, result);
	}
	...
	public void test_email_Cases() {
		List<Boolean> result = emailTestCases
				.apply(Arrays.asList("abc@1.com", "abc@2.com", "abc@3.com", "abc@4.com", "sdvs@"));
		List<Boolean> expected = Arrays.asList(true, true, true, true, false);
		assertEquals(expected, result);
	}
	...
	public void test_phoneNumber_Cases() {
		List<Boolean> result = phoneTestCases
				.apply(Arrays.asList("91 7066944829", "91 7447855795", "91 8180908638", "91 9657475623", "2354453454"));
		List<Boolean> expected = Arrays.asList(true, true, true, true, false);
		assertEquals(expected, result);
	}
	...
	public void test_password_Cases() {
		List<Boolean> result = passwordTestCases
				.apply(Arrays.asList("Jayesh@2017", "Akshara@2017", "Nikita@2017", "Neha@2017", "sdfs@2017"));
		List<Boolean> expected = Arrays.asList(true, true, true, true, false);
		assertEquals(expected, result);
	}
