...
//    public static String CONTACT_READ_JSON = "src/main/resources/ContactRead.csv";
	...
	void addContact() {
		Contact obj1 = new Contact(1, "Naresh", "Vikram", "SLC", "Benguluru", "KA", "462022", "1234", "abc@gmail.com");
		Contact obj2 = new Contact(2, "Anju", "Kumar", "BD", "Jaipur", "Rajasthan", "462025", "5678", "def@gmail.com");
		Contact obj3 = new Contact(3, "Arun", "Verma", "CB", "Bhopal", "MP", "462052", "3245", "ghi@gmail.com");
